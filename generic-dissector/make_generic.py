...
glue_lo_file_name = os.path.splitext(glue_file_name)[0] + '.lo'
...
os.system('libtool --tag=CC --mode=compile c++ -g -O2 -c ' + glue_file_name)
...
shutil.copy(glue_o_file_name, os.path.join(plugin_dir, '.libs' ))
shutil.copy(glue_lo_file_name, plugin_dir)
